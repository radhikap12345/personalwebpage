...
document.getElementById("loadedsection").style.visibility = 'hidden';
document.getElementById("loadedsection").style.display = 'none';
window.onload = ()=>{
    document.getElementById("loader").style.display = 'none';
    document.getElementById("loadedsection").style.visibility = 'visible';
...
var body = document.getElementById("loadedsection");
